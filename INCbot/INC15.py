...
# Сопоставление chat_id к названию группы (добавьте свои)
GROUP_NAMES = {
    -1002783899407: "Мбизнес",
    -1002591060921: "Группа 1",
    -1002631818202: "Группа 2",
    # Добавляйте другие группы здесь
}
    ...
    # --- Изменение приоритета ---
        ...
        if reply_to:
            ...
            if "поднят до" in text and ("Высокий" in text or "Наивысший" in text):
                ...
                # Обновляем время на сейчас - с него начинаем отсчёт
                incident["time"] = datetime.datetime.now(tz=ZoneInfo("Asia/Bishkek"))
